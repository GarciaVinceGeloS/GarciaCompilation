...
//PASSING THE DATA FROM HTML TO PHP AND STORE IT IN VARIABLES if 
...
$sql = "INSERT INTO `studenttb` (`firstname`, `lastname`, `age`, `address`, `contact`,`birthday`) VALUES ('$first_name','$last_name','$age','$address','$contact','$birthday')";
